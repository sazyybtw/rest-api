...
func (s *UserService) handleUserRegister(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteJSON(w, http.StatusInternalServerError, ErrorResponse{Error: "Erro criando usuario"})
		return
	}
...
func (s *UserService) handleUserLogin(w http.ResponseWriter, r *http.Request) {
	// 1. Encontra o usuario no banco de dados pelo email
	// 2. Compara a senha com a senha criptografada
	// 3. Cria um JWT e transforma em um cookie
	// 4. Retorna o JWT em resposta
}
